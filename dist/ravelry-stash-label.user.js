...
/***/ function(module, exports, __webpack_require__) {
	...
	var _kjua = __webpack_require__(3);
	
	var _kjua2 = _interopRequireDefault(_kjua);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	(0, _jquery2.default)('<a href="#" />').addClass('button').append('<span>&#9113; print label</span>').on('click', show_label).insertBefore('#stash_owner_button_set div.c_d');
	
	function show_label() {
	  var info = gather_info();
	  var template = '<div class=\'label_strip\'>\n                    <div style=\'display: flex; flex-direction: row;\'>\n                        <div class=\'label_info\' style=\'text-align: left\'>\n                        <div id=\'stash_name\'>' + info.stash.name + '</div>\n                        <div>' + info.yarn.yarn_name + ' ' + info.yarn.yarn_company + '</div>\n                        <div>' + info.yarn.fiber_and_weight + ', ' + info.yarn.fibers + '</div> \n                        <div>' + info.yarn.yardage + '</div> \n                        <div>colorway: ' + info.stash.colorway + ', dye lot: ' + info.stash.dye_lot + '</div> \n                    </div>\n                    <div id=\'qrcode\' />\n                </div>';
	
	  (0, _jquery2.default)('body').html(template).attr('class', '').append("<style>@media print { @page { orientation: landscape } }</style>");
	
	  document.querySelector('#qrcode').appendChild((0, _kjua2.default)({
	    text: window.location.toString(),
	    size: 100,
	    crisp: true
	  }));
	
	  (0, _jquery2.default)('.label_strip').css({
	    'padding-left': '25%',
	    'margin-top': '3cm',
	  ...
	  (0, _jquery2.default)('.label_info').css({
	    'margin-right': '0.5cm'
	  });
	
	  (0, _jquery2.default)('#stash_name').css({
	    'font-size': 'large',
	    'font-weight': 'bold'
	  });
	}
	...
	function gather_info() {
	  ...
	  var stash = info.stash = {};
	
	  stash.name = (0, _jquery2.default)('#content .heading h2').contents().map(function () {
	    return this.nodeType == 3 ? this.nodeValue : undefined;
	  }).get().join('');
	
	  (0, _jquery2.default)('.core_item_inner .fields div.field').each(function () {
	    stash[(0, _jquery2.default)(this).children('label').text().toLowerCase().replace(/ /g, '_')] = (0, _jquery2.default)(this).children('.value').html();
	  });
	
	  var yarn = info.yarn = {};
	
	  (0, _jquery2.default)('#yarn_summary .yarn_summary .yarn_summary_content div').each(function () {
	    yarn[(0, _jquery2.default)(this).attr('class')] = (0, _jquery2.default)(this).html();
	  });
...
/***/ }
/******/ ]);
//# sourceMappingURL=ravelry-stash-label.user.js.map